<h2><a href="https://www.geeksforgeeks.org/problems/upper-case-conversion5419/1">Capitalize First Letter of Words</a></h2><h3>Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a string <strong>s</strong>,&nbsp;convert the first letter of each word in the string to uppercase.&nbsp;</span></p>
